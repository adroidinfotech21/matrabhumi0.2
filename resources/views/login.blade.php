@include('includes/header');
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-4"><img src="images/login_banner.png" alt=""></div>
      <div class="col-sm-6">
        <div class="login_form">
          <form action="">
            <input type="text" name="" id="" placeholder="Enter Email Id or Numbere">
                ...
                <div class="agent-p-form">
                  <form action="#" class="callus clearfix">
                    <div class="single-query form-group col-sm-12">
                      <input type="text" class="keyword-input" placeholder="Enter Email ID Or Number ">
                    </div>
                    <div class="single-query form-group  col-sm-12">
                      <input type="text" class="keyword-input" placeholder="Enter OTP">
                    </div>
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="col-sm-6">
