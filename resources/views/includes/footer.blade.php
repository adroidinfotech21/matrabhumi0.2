  ...
  <div class="container padding_top">
    ...
    <div class="container padding_top">
      <div class="row">
        <div class="col-md-3 col-sm-6">
          <div class="footer_panel bottom30">
            <a href="#." class="logo bottom30"><img src="{{asset('images/footer_logo.png')}}" alt="logo"
                width="180px"></a>
      ...
      <div class="copyright_simple">
        <div class="row">
          <div class="col-md-6 col-sm-5 top20 bottom20">
            <p>Copyright &copy; 2024 <span>Matrabhumi</span>. All rights reserved.Developed By AnyTechPros InfoTech LLP
            </p>
          </div>
