        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <ul class="f-p-links margin_bottom">
                    <li><a href="{{url('user-profile') }}"><i class="icon-icons230"></i>Profile</a></li>
                    ...
                    <li><a href="{{url('favoriteproperty') }}" class="active"><i class="icon-icons43"></i> Favorite
                            Properties</a></li>
                ...
                <div class="property_item heading_space">
                    ...
                    <div class="proerty_content">
                        ...
                        <div class="favroute clearfix">
                            ...
                            <ul class="pull-right">
                                <li><a href="#."><i class="icon-like"></i></a></li>
                                <li><a href="#two" class="share_expender" data-toggle="collapse"><i
                                            class="icon-share3"></i></a></li>
                            </ul>
                        </div>
                ...
                <div class="property_item heading_space">
                    ...
                    <div class="proerty_content">
                        ...
                        <div class="favroute clearfix">
                            ...
                            <ul class="pull-right">
                                <li><a href="#."><i class="icon-like"></i></a></li>
                                <li><a href="#eight" class="share_expender" data-toggle="collapse"><i
                                            class="icon-share3"></i></a></li>
                            </ul>
                        </div>
                ...
                <div class="property_item heading_space">
                    ...
                    <div class="proerty_content">
                        ...
                        <div class="favroute clearfix">
                            ...
                            <ul class="pull-right">
                                <li><a href="#."><i class="icon-like"></i></a></li>
                                <li><a href="#nine" class="share_expender" data-toggle="collapse"><i
                                            class="icon-share3"></i></a></li>
                            </ul>
                        </div>
